...
public struct TableComponentTokens {
    ...
    public static let cell_even_fill_default = Color.adaptive(light: ElevateAliases.Layout.Layer.ground, dark: ElevateAliases.Layout.Layer.ground)
    ...
    public static let cell_even_fill_selected_disabled_default = Color.adaptive(light: ElevateAliases.Layout.Layer.ground, dark: ElevateAliases.Layout.Layer.ground)
    ...
    public static let cell_odd_fill_default = Color.adaptive(light: ElevateAliases.Layout.Layer.elevated, dark: ElevateAliases.Layout.Layer.elevated)
    ...
    public static let cell_odd_fill_selected_disabled_default = Color.adaptive(light: ElevateAliases.Layout.Layer.elevated, dark: ElevateAliases.Layout.Layer.elevated)
    ...
    public static let column_fill_default = Color.adaptive(light: ElevateAliases.Layout.Layer.sunken, dark: ElevateAliases.Layout.Layer.sunken)
